...
{
	$connection_edit_link = "data.import_connection_edit.php?ID=".$f_ID.'&PLAN_ID='.$f_PLAN_ID."&lang=".LANG;
	$connection_copy_link = "data.import_connection_edit.php?COPY_ID=".$f_ID."&lang=".LANG;
...
if ($moduleAccessLevel>="W")
{
	$aContext = array(
		array(
			...
			"LINK"=>"data.import_connection_edit.php?lang=".LANGUAGE_ID."&PLAN_ID=".$arFilter["PLAN_ID"],
			"TITLE"=>GetMessage("ADD_CONNECTION_TITLE")
		),
		array(
			"TEXT"=>GetMessage("IMPORT_CONNECTIONS"),
			"LINK"=>"data.import_connections_import.php?lang=".LANGUAGE_ID."&PLAN_ID=".$arFilter["PLAN_ID"],
