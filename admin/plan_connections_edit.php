...
if($back_url=='')
	$back_url = "data.import_plan_edit.php?ID=".$ID."&lang=".LANG;
...
if($REQUEST_METHOD == "POST" && ($save!="" || $apply!="") && $moduleAccessLevel=="W" && check_bitrix_sessid()) 
{
	...
	if($res)
	{
		if ($apply != "")
			...
			LocalRedirect("/bitrix/admin/data.import_plan_edit.php?ID=".$ID."&lang=".LANG);
	}
	else
	{
...
$aMenu = array(
	array(
		...
		"LINK"=>"data.import_plan_edit.php?ID=".$ID."&lang=".LANG,
		"ICON"=>"btn_list",
	)
);
...
if($SHOW_ACTIVE != "Y")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_ACTIVE=Y",
		"ICON"  => "",
	);
}
...
if($SHOW_ACTIVE != "N")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_ACTIVE=N",
		"ICON"  => "",
	);
}
...
if($SHOW_REQUIRED != "Y")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_REQUIRED=Y",
		"ICON"  => "",
	);
}
...
if($SHOW_REQUIRED != "N")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_REQUIRED=N",
		"ICON"  => "",
	);
}
...
if($SHOW_IMAGE != "Y")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_IMAGE=Y",
		"ICON"  => "",
	);
}
...
if($SHOW_IMAGE != "N")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_IMAGE=N",
		"ICON"  => "",
	);
}
...
if($SHOW_FILE != "Y")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_FILE=Y",
		"ICON"  => "",
	);
}
...
if($SHOW_FILE != "N")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_FILE=N",
		"ICON"  => "",
	);
}
...
if($SHOW_URL != "Y")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_URL=Y",
		"ICON"  => "",
	);
}
...
if($SHOW_URL != "N")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_URL=N",
		"ICON"  => "",
	);
}
...
if($SHOW_SEARCH != "Y")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_SEARCH=Y",
		"ICON"  => "",
	);
}
...
if($SHOW_SEARCH != "N")
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG."&SHOW_SEARCH=N",
		"ICON"  => "",
	);
}
...
if($SHOW_ACTIVE || $SHOW_REQUIRED || $SHOW_IMAGE || $SHOW_FILE || $SHOW_URL || $SHOW_SEARCH)
{
	$aSubMenu[] = array(
		...
		"LINK"=>"data.import_plan_connections_edit.php?ID={$ID}&lang=".LANG,
		"ICON"  => "view",
	);
}
...
<tr>
	<td colspan="2" align="center">
		...
		function AddConnectionRow(tableID)
		{
			...
			DataCoreAddNewCellButton(newRow, 'center', 'button', function(){DataCoreRemoveRow(newRowId)}, '', 'ui-btn ui-btn-danger ui-btn-icon-remove');
			DataCoreAddNewCellSelect(newRow, 'center', 'PROCESSING_TYPES[' + 'new_' + (rows - 1) + '][]', ProcessingTypesValues, ProcessingTypesLabels, false, true, true);
			<?if($plan_IMPORT_IBLOCK_PROPERTIES=="Y"){?>
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_ELEMENT_PROPERTY_M[]', IblockPropertiesMapValues, IblockPropertiesMapLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_ELEMENT_PROPERTY_G[]', IblockSectionFieldsValues, IblockSectionFieldsLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_ELEMENT_PROPERTY_E[]', IblockFieldsValues, IblockFieldsLabels);
			<? } ?>
			DataCoreAddNewCellSelect(newRow, 'center', 'USE_IN_CODE[]', UseInCodeValues, UseInCodeLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'USE_IN_SEARCH[]', CheckboxValues, CheckboxLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IS_REQUIRED[]', CheckboxValues, CheckboxLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IS_ARRAY[]', CheckboxValues, CheckboxLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IS_FILE[]', CheckboxValues, CheckboxLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IS_URL[]', CheckboxValues, CheckboxLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IS_IMAGE[]', CheckboxValues, CheckboxLabels);
			<?if($plan_IMPORT_HIGHLOAD_BLOCK_ENTITIES=="Y"){?>
			DataCoreAddNewCellSelect(newRow, 'center', 'HIGHLOAD_BLOCK_ENTITY_FIELD[]', HighloadEntitiesValues, HighloadEntitiesLabels);
			<? } ?>
			<?if($plan_IMPORT_CATALOG_STORE_AMOUNT=="Y"){?>
			DataCoreAddNewCellSelect(newRow, 'center', 'CATALOG_PRODUCT_STORE_AMOUNT[]', CatalogStoresValues, CatalogStoresLabels);
			<? } ?>
			<?if($plan_IMPORT_CATALOG_PRICES=="Y"){?>
			DataCoreAddNewCellSelect(newRow, 'center', 'CATALOG_PRODUCT_PRICE[]', CatalogPricesValues, CatalogPricesLabels);
			<? } ?>
			<? if($plan_IMPORT_CATALOG_PRODUCT_OFFERS == "Y" && $isCatalogSKU) { ?>
			DataCoreAddNewCellSelect(newRow, 'center', 'CATALOG_PRODUCT_OFFER_FIELD[]', CatalogFieldsValues, CatalogFieldsLabels);
			<? } ?>
			<?if($plan_IMPORT_CATALOG_PRODUCTS=="Y"){?>
			DataCoreAddNewCellSelect(newRow, 'center', 'CATALOG_PRODUCT_FIELD[]', CatalogFieldsValues, CatalogFieldsLabels);
			<? } ?>
			<? if($plan_IMPORT_CATALOG_PRODUCT_OFFERS == "Y" && $isCatalogSKU) {?>
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_ELEMENT_OFFER_PROPERTY[]', IblockOffersPropertiesValues, IblockOffersPropertiesLabels);
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_ELEMENT_OFFER_FIELD[]', IblockFieldsValues, IblockFieldsLabels);
			<? } ?>
			<?if($plan_IMPORT_IBLOCK_PROPERTIES=="Y"){?>
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_ELEMENT_PROPERTY[]', IblockPropertiesValues, IblockPropertiesLabels);
			<? } ?>
			<?if($plan_IMPORT_IBLOCK_ELEMENTS=="Y"){?>
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_ELEMENT_FIELD[]', IblockFieldsValues, IblockFieldsLabels);
			<? } ?>
			<?if($plan_IMPORT_IBLOCK_SECTIONS=="Y"){?>
			<?if($plan_IMPORT_FORMAT == "XML") { ?>
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_SECTION_PARENT_FIELD[]', IblockSectionFieldsValues, IblockSectionFieldsLabels);
			<? } else {	?>
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_SECTION_DEPTH_LEVEL[]', sectionDepthLevelsValues, sectionDepthLevelsLabels);
			<? } ?>
			DataCoreAddNewCellSelect(newRow, 'center', 'IBLOCK_SECTION_FIELD[]', IblockSectionFieldsValues, IblockSectionFieldsLabels);
			<? } ?>
			DataCoreAddNewCellInput(newRow, 'center', 'number', 'SORT[]', 500);
			<?if($plan_IMPORT_FORMAT == "XML" || $plan_IMPORT_FORMAT == "JSON") { ?>
			DataCoreAddNewCellInput(newRow, 'center', 'text', 'ENTITY_ATTRIBUTE[]');
			<? } ?>
			DataCoreAddNewCellSelect(newRow, 'center', 'ACTIVE[]', CheckboxValues, CheckboxLabels);
			DataCoreAddNewCellInput(newRow, 'center', '<?=($plan_IMPORT_FORMAT == "XML" && $plan_XML_USE_ENTITY_NAME == "Y") ? 'text' : 'hidden';?>', 'NAME[]', false, false, false, '<?=($plan_IMPORT_FORMAT == "XML" && $plan_XML_USE_ENTITY_NAME == "Y") ? 'entitiesArray' : '';?>', <?=$plan_IMPORT_FORMAT != "XML" ? 'true' : 'false';?>);
			<?if(($plan_IMPORT_FORMAT == "XML" && $plan_XML_USE_ENTITY_NAME != "Y") || $plan_IMPORT_FORMAT != "XML") { ?>
			DataCoreAddNewCellSelect(newRow, 'center', 'ENTITY[]', EntitiesValues, EntitiesLabels);
			<? } ?>
			DataCoreAddNewCellInput(newRow, 'center', 'hidden', 'CONNECTIONS_ID[]');
		...
		<table class="internal" id="table_CONNECTIONS">
			<tbody>
				...
				<tr class="data-row" id="row_connection_<?=$CONNECTIONS_ID;?>" onClick="javascript:CheckRowClass(this);" style="display: <?=CheckDisplay($connectionArr);?>">
					...
					<td align="center">
						<button class="ui-btn ui-btn-danger ui-btn-icon-remove" type="button" onClick="DataCoreRemoveRow('row_connection_<?=$CONNECTIONS_ID;?>')" title="<?=Loc::getMessage("BTN_DELETE_CONNECTION");?>"<?=$moduleAccessLevel != 'W'?' disabled=""':''?> /></button>
					</td>
				</tr>
				<?
				}
...
if($ID>0)
{
	...
	elseif($scriptData)
	{
		...
		{
			echo '<h3>'.Loc::getMessage('DATA_IMPORT_NOTE_3').'</h3>';
			echo '<div class="adm-list-table-wrap"><table class="adm-list-table"><thead><tr class="adm-list-table-header"><td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">'.Loc::getMessage('DATA_IMPORT_NOTE_4').'</div></td><td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">'.Loc::getMessage('DATA_IMPORT_NOTE_5').'</div></td></tr></thead><tbody>';
