...
{
	$processing_edit_link = "data.import_processing_setting_edit.php?ID=".$f_ID."&lang=".LANG;
	$processing_copy_link = "data.import_processing_setting_edit.php?COPY_ID=".$f_ID."&lang=".LANG;
