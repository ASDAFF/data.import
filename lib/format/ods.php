...
class ODS
{
	...
	function __construct()
	{
		...
		{
			$errorArray = Array(
				"MESSAGE" => Loc::getMessage("DATA_IMPORT_ERROR_PHP_EXTENSION_ZIP_NOT_INCLUDED"),
		...
		{
			$errorArray = Array(
				"MESSAGE" => Loc::getMessage("DATA_IMPORT_ERROR_PHP_EXTENSION_XMLREADER_NOT_INCLUDED"),
