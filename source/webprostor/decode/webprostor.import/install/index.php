...
class webprostor_import extends CModule
{
    const MODULE_ID = 'webprostor.import';
    var $MODULE_ID = 'webprostor.import';
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage('WEBPROSTOR_IMPORT_MODULE_NAME');
        $this->MODULE_DESCRIPTION = GetMessage('WEBPROSTOR_IMPORT_MODULE_DESC');
        $this->PARTNER_NAME = GetMessage('WEBPROSTOR_IMPORT_PARTNER_NAME');
        $this->PARTNER_URI = GetMessage('WEBPROSTOR_IMPORT_PARTNER_URI');
    }
    ...
    function UnInstallFiles($_35409257 = array())
    {
        ...
        DeleteDirFilesEx('/bitrix/gadgets/webprostor/import.agents/');
    ...
    function DoInstall()
    {
        ...
        $step = IntVal($step);
        if ($step < 2) {
            $GLOBALS['APPLICATION']->IncludeAdminFile(GetMessage('WEBPROSTOR_MODULE_INSTALL'), $_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/' . self::MODULE_ID . '/install/install_1.php');
        } elseif ($step == 2) {
    ...
    function DoUninstall()
    {
        ...
        $step = IntVal($step);
        if ($step < 2) {
            $GLOBALS['APPLICATION']->IncludeAdminFile(GetMessage('WEBPROSTOR_MODULE_DELETE'), $_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/' . self::MODULE_ID . '/install/uninstall_1.php');
        } elseif ($step == 2) {
    ...
    {
        $_2033152511 = array('reference_id' => array('D', 'R', 'T', 'W'), 'reference' => array('[D] ' . GetMessage('WEBPROSTOR_IMPORT_RIGHT_DENIED'), '[R] ' . GetMessage('WEBPROSTOR_IMPORT_RIGHT_READ'), '[T] ' . GetMessage('WEBPROSTOR_IMPORT_RIGHT_MANUALLY'), '[W] ' . GetMessage('WEBPROSTOR_IMPORT_RIGHT_ADMIN')));
        return $_2033152511;
    }
} ?>