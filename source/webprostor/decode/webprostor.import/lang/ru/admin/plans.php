...
$MESS["IMPORT_FILE_URL"] = "Ссылка для скачивания файла импорта";
...
$MESS["AGENT_INTERVAL_URL"] = "Интервал обновления загрузки файла (сек.)";
$MESS["WEBPROSTOR_IMPORT_AGENT_OPEN"] = "Перейти";
$MESS["WEBPROSTOR_IMPORT_NO_AGENT"] = "Агент не задан";
$MESS["WEBPROSTOR_IMPORT_AGENT_DELETED"] = "Агент удален, требуется пересохранить план импорта";
$MESS["WEBPROSTOR_IMPORT_AGENT_DEACTIVTED"] = "Агент деактивирован, требуется пересохранить план импорта или активировать агент вручную";
$MESS["LAST_IMPORT_DATE"] = "Дата запуска цикла";
$MESS["LAST_STEP_IMPORT_DATE"] = "Дата запуска шага";
$MESS["LAST_FINISH_IMPORT_DATE"] = "Дата завершения цикла";
$MESS["CRON_PROGRESS"] = "Прогресс выполнения cron";
$MESS["CRON_PROGRESS_VALUE"] = "#CURRENT# из #TOTAL#";

$MESS["LIST_DEACTIVATE"] = "Деактивировать агент";
$MESS["LIST_ACTIVATE"] = "Активировать агент";
