<?
$MESS["MODULE_DEMO_EXPIRED"] = "webprostor.import: Демо режим закончился, вы можете купить модуль в <a href=\"https://marketplace.1c-bitrix.ru/solutions/webprostor.import/\" target=\"_blank\">Marketplace</a>";
...
$MESS["ERROR_ENTITIES_AND_NAMES_NOT_IDENTICAL_NOTIFY"] = "План импорта: #PLAN_ID#. Названия сущностей не совпадают с содержимым файла. <a href='/bitrix/admin/webprostor.import_plan_connections_edit.php?ID=#PLAN_ID#&lang=#LANG_ID#'>Проверьте файл или настройки сопоставлений</a>";
...
$MESS["LOGS_ARE_TOO_BIG"] = "webprostor.import: Слишком большой объемов логов! Это может привести к падению БД. Очистите журнал событий. <a href=\"/bitrix/admin/webprostor.import_logs.php?lang=".LANGUAGE_ID."\">перейти в журнал</a>";
$MESS["CURL_NOT_INCLUDED"] = "webprostor.import: Не подключено расширение <a target=\"_blank\" href=\"http://php.net/manual/ru/book.curl.php\">CURL</a>";
$MESS["ZIP_NOT_INCLUDED"] = "webprostor.import: Не подключено расширение <a target=\"_blank\" href=\"https://www.php.net/manual/ru/book.zip.php\">Zip</a>";
$MESS["ZLIB_NOT_INCLUDED"] = "webprostor.import: Не подключено расширение <a target=\"_blank\" href=\"https://www.php.net/manual/ru/book.zlib.php\">Zlib</a>";
$MESS["RAR_NOT_INCLUDED"] = "webprostor.import: Не подключено расширение <a target=\"_blank\" href=\"https://www.php.net/manual/ru/book.rar.php\">Rar</a>";
?>