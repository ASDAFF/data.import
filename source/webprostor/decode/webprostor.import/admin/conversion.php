...
$cConversion = new CWebprostorImportConversion;
...
{
	$availableTags[] = str_replace("WEBPROSTOR_IMPORT_", "", $notifArr["TAG"]);
}
...
if($CONVERSION == "Y" && isset($CONVERSION_TYPE) && in_array($CONVERSION_TYPE, $availableTags) && $moduleAccessLevel=="W")
{
	...
	if($result)	
	{
		CAdminNotify::DeleteByTag("WEBPROSTOR_IMPORT_".$CONVERSION_TYPE);
