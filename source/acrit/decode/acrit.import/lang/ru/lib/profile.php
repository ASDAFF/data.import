...
$MESS["PROFILE_ENTITY_ACTIONS_DEFAULT_CATALOG_FIELDS_FIELD"] = "Поля товаров QUANTITY_TRACE, CAN_BUY_ZERO взять из настроек торгового каталога";
...
$MESS["PROFILE_ENTITY_SCAN_ALL_ITEMS_TO_FIND_FIELDS_FIELD"] = "Собрать уникальные параметры со всех элементов выгрузки";
