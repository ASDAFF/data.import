CREATE TABLE IF NOT EXISTS `data_import_plans` (
...
CREATE TABLE IF NOT EXISTS `data_import_plans_connections` (
  `ID` INT(18) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `data_import_processing_settings` (
  `ID` INT(18) NOT NULL AUTO_INCREMENT,
  `ACTIVE` char(1) NOT NULL DEFAULT 'Y',
  `SORT` INT(11) NOT NULL DEFAULT '500',
...
CREATE TABLE IF NOT EXISTS `data_import_search_id` (
  `ID` INT(18) NOT NULL AUTO_INCREMENT,
